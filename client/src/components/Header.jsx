    ...
    return (
        <div className='header-container'>
            <header>
                ...
                <img id='logo' src={logo} alt='WhoDat?'></img>
            ...
            <dialog ref={modal}>
                <div className='how-to-play'>
                    ...
                    <div className='span-container'>
                        ...
                        <p>{<span id='hard-span'>Hard</span>} - Guess the NBA player based on their silhouette. (Hints recommended)</p>
                    </div>
                    <hr></hr>
                    <h3>Settings:</h3>
                    <div className='settings'>
                        <span className='menu-info'>Click the 
                            ...
                            menu to toggle Lives, Hints, and Timer. 
                            
                        </span>
                        <span>Enabling each setting will reveal further customization, such as number of lives, timer limit, and specific hints.</span>
                    </div>

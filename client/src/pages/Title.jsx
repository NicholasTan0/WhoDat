...
export default function Title({ setDifficulty, screen, setScreen }){
    return (
        <div className="h-full w-full">
            <div class="pointer-events-none fixed top-0 left-0 w-72 h-72 bg-white rounded-full blur-[120px] animate-[pulse_4s_ease-in-out_infinite]"/>
            <div className="h-full w-full grid grid-cols-1 grid-rows-[auto_1fr_auto] border-x-0 border-offwhite">
